(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(screenState, dialog, router) {
                    this.screenState = screenState;
                    this.dialog = dialog;
                    this.router = router;
                }
                ...
                HeaderComponent.prototype.onLogout = function () {
                    ...
                    var dialogRef = this.dialog.open(LogoutConfirmDialog, {
                        width: '250px',
                        data: this.username
                    });
                ...
                HeaderComponent.prototype.showInfo = function () {
                    var dialogRef = this.dialog.open(AppInfoDialog, {
                        width: '400px',
                    });
                };
            ...
            var LogoutConfirmDialog = /** @class */ (function () {
                function LogoutConfirmDialog(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                }
                LogoutConfirmDialog.prototype.ngOnInit = function () {
                };
                LogoutConfirmDialog.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                return LogoutConfirmDialog;
            }());
            LogoutConfirmDialog.ctorParameters = function () { return [
            ...
            var AppInfoDialog = /** @class */ (function () {
                ...
                AppInfoDialog.prototype.ngOnInit = function () {
                };
                AppInfoDialog.prototype.FBRedirect = function () {
                    window.open("https://www.facebook.com/soumyadip.chattopadhyay.1", "_blank");
                };
                AppInfoDialog.prototype.LIRedirect = function () {
                    window.open("https://www.linkedin.com/in/soumyadip-c-95106186", "_blank");
                };
                AppInfoDialog.prototype.GMRedirect = function () {
                    var emailTo = "soumya.c11@gmail.com";
                    var emailCC = "onestopmusic.osm@yahoo.com";
                    var emailSub = "One Stop Music Feedback/ Contact Creator";
                    window.open('mailto:' + emailTo, '_blank');
                };
                AppInfoDialog.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                return AppInfoDialog;
            }());
            AppInfoDialog.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] },
                { type: String, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_DIALOG_DATA"],] }] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LauncherComponent = /** @class */ (function () {
                function LauncherComponent(screenState, styleSetter, router, loginDtaFetcher) {
                    this.screenState = screenState;
                    this.styleSetter = styleSetter;
                    this.router = router;
                ...
                LauncherComponent.prototype.ngOnInit = function () {
                    ...
                    setTimeout(function () {
                        ...
                        _this.errorShowConf = true;
                    }, 30000);
                    this.loginDtaFetcher.getUser('Soumyadip').subscribe(function (name) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var launcherStyleService = /** @class */ (function () {
                ...
                launcherStyleService.prototype.loginStyleSetter = function (scrSz) {
                    var boxSize = 0.4 * Math.min(scrSz.width, scrSz.height);
                    return {
                        'width': boxSize * 2 + 'px',
                        'height': boxSize + 'px',
                        'position': 'absolute',
                ...
                launcherStyleService.prototype.errorStyleSetter = function (scrSz) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ModalCompComponent = /** @class */ (function () {
                function ModalCompComponent(dialogRef, data, youtube) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                ...
                ModalCompComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.showLoading = true;
                    this.youtube.search(this.data.search).subscribe(function (searchList) {
                        _this.searchResults = searchList;
                        if (_this.searchResults.length == 0) {
                            _this.isEmptySearch = true;
                            return;
                        }
                        if (_this.data.type == 1) {
                            _this.searchResults = _this.searchResults.slice(0, 4);
                        }
                        else {
                            _this.searchResults = _this.searchResults.slice(0, 20);
                        }
                        for (var result in _this.searchResults) {
                            _this.checkboxBool.push(false);
                        }
                        _this.showLoading = false;
                        _this.isEmptySearch = false;
                        _this.titleText = ('').concat(_this.searchResults[0].title.split('|')[0].substring(0, 30));
                        _this.selectedVal = _this.searchResults[0];
                    });
                };
                ...
                ModalCompComponent.prototype.sendData = function () {
                    //console.log("sending....");
                    var resultArr = [];
                    for (var result in this.searchResults) {
                ...
                return ModalCompComponent;
            }());
            ModalCompComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicAddComponent = /** @class */ (function () {
                function MusicAddComponent(dialog, screenState, musicDataFetcher, dataFetcher) {
                    this.dialog = dialog;
                    this.screenState = screenState;
                ...
                MusicAddComponent.prototype.onError = function () {
                    var errVal = ["", [["No results"]]];
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["of"])(errVal);
                };
                MusicAddComponent.prototype.beforeSuggestions = function () {
                    this.suggestions = [];
                    this.showSuggestions = true;
                    this.showSuggestionsLoading = true;
                };
                MusicAddComponent.prototype.hideClick = function () {
                    var _this = this;
                    if (this.isOpen) {
                        ...
                        setTimeout(function () {
                            ...
                            _this.onSearch.emit(_this.hideSearch);
                        }, 300);
                    }
                    else {
                ...
                MusicAddComponent.prototype.openDialog = function (type) {
                    var _this = this;
                    if (this.input) {
                    ...
                    var dialogRef = this.dialog.open(_modal_comp_modal_comp_component__WEBPACK_IMPORTED_MODULE_7__["ModalCompComponent"], {
                        width: '500px',
                        data: { id: '',
                            title: '',
                ...
                MusicAddComponent.prototype.addValue = function (id, title, thumb) {
                    var _this = this;
                    var videoElem = {
                        videoId: id,
                    ...
                    if (localStorage.getItem('loggedIn') && localStorage.getItem('loggedIn') == 'true') {
                        var user = localStorage.getItem('username') ? localStorage.getItem('username') : 'Guest';
                        if (user != 'Guest') {
                ...
                MusicAddComponent.prototype.setSuggestions = function (data) {
                    var results = (JSON.parse(data[0])[1]);
                    results = results.map(function (item) { return item[0]; });
                    this.suggestions = results.slice(0, 5);
                    this.showSuggestionsLoading = false;
                };
                MusicAddComponent.prototype.onChangeInput = function (query) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicPlayerComponent = /** @class */ (function () {
                function MusicPlayerComponent(screenState, loginDtaFetcher, styleSetter, musicDataFetcher, playlistFetcher) {
                    this.screenState = screenState;
                    this.loginDtaFetcher = loginDtaFetcher;
                    this.styleSetter = styleSetter;
                    this.musicDataFetcher = musicDataFetcher;
                ...
                MusicPlayerComponent.prototype.ngOnInit = function () {
                    ...
                    this.sub = Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["interval"])(25 * 60 * 1000)
                        ...
                        _this.loginDtaFetcher.getUser('Soumyadip').subscribe(function (name) {
                            console.log("Keep Server Alive");
                        });
                    });
                };
                MusicPlayerComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    this.screenState.screenSize.subscribe(function (screen) {
                        if (!_this.initCallDone) {
                            _this.largePlayer = screen.isMobile;
                            _this.initCallDone = true;
                        }
                        _this.onScreensizeChange(screen, (screen.isMobile && _this.expanded));
                    });
                    ...
                    if (localStorage.getItem('loggedIn') !== null) {
                        ...
                        if (this.loggedInUser != 'Guest') {
                            ...
                            var lastPlaylist_1 = (localStorage.getItem('playlist') != null && localStorage.getItem('playlist') != 'undefined') ? JSON.parse(localStorage.getItem('playlist')) : null;
                            var lastIndexId_1 = (localStorage.getItem('lastIndex') != null && localStorage.getItem('lastIndex') != 'undefined') ? JSON.parse(localStorage.getItem('lastIndex')) : null;
                            this.playlistFetcher.getAllPlaylists(this.usernm).subscribe(function (playlsts) {
                                _this.playlists = _this.playlists.concat(playlsts);
                                _this.addable = playlsts.length < 4;
                                var defVal = '';
                                var index = 0;
                                playlsts.forEach(function (plst) {
                                    index++;
                                    if (lastPlaylist_1 != null && plst.id == lastPlaylist_1) {
                                        defVal = plst.playlist;
                                        _this.defaultPlaylist = plst;
                                        _this.selectedPlaylist = index;
                                    }
                                    else if (lastPlaylist_1 === null && plst.isDefault == 'Y') {
                                        defVal = plst.playlist;
                                        _this.defaultPlaylist = plst;
                                        _this.selectedPlaylist = index;
                                    }
                                });
                                _this.musicDataFetcher.getAllSongs(_this.usernm).subscribe(function (songList) {
                                    _this.playerQueue = songList;
                                    if (defVal == '') {
                                        _this.playerQueue = _this.playerQueue.filter(function (x) { return x.playlist == null; });
                                    }
                                    else {
                                        _this.playerQueue = _this.playerQueue.filter(function (x) { return x.playlist == defVal; });
                                    }
                                    _this.playerQueue = _this.playerQueue.filter(function (x) { return x.videoId != null; });
                                    for (var song in _this.playerQueue) {
                                        if (lastIndexId_1 != null && _this.playerQueue[song].id == lastIndexId_1) {
                ...
                MusicPlayerComponent.prototype.onChangePlaylist = function (index) {
                    var _this = this;
                    localStorage.setItem('playlist', JSON.stringify(this.playlists[index].id));
                    this.selectedPlaylist = index;
                    this.musicDataFetcher.getAllSongs(this.usernm).subscribe(function (songList) {
                        _this.playerQueue = songList;
                        if (index == 0) {
                            _this.playerQueue = _this.playerQueue.filter(function (x) { return x.playlist == null; });
                        }
                        else {
                            _this.playerQueue = _this.playerQueue.filter(function (x) { return x.playlist == _this.playlists[index].playlist; });
                        }
                        _this.playerQueue = _this.playerQueue.filter(function (x) { return x.videoId != null; });
                    });
                ...
                MusicPlayerComponent.prototype.onLargePlayerChange = function (isLarge) {
                    this.largePlayer = isLarge;
                    this.queueComp.scrollPlacement();
                    //this.expanded=false;
                    //this.onExpCollapse(this.expanded);
                };
                MusicPlayerComponent.prototype.onIndexChange = function (index) {
                    this.currentIndex = index;
                    this.queueComp.scrollPlacement();
                    localStorage.setItem('lastIndex', JSON.stringify(this.playerQueue[index].id));
                };
                MusicPlayerComponent.prototype.onDeletePlaylist = function (index) {
                    var _this = this;
                    ...
                    this.playlistFetcher.deletePlaylist(this.playlists[index]).subscribe(function (data) {
                        _this.playlists.splice(index, 1);
                        _this.addable = true;
                    });
                };
                MusicPlayerComponent.prototype.onModifyPlaylist = function (input) {
                    var _this = this;
                    if (this.playlists[input.index].id == this.defaultPlaylist.id && !input.isDefault) {
                        ...
                        var prevDefault = this.defaultPlaylist;
                        if (prevDefault.id != -1) {
                            prevDefault.isDefault = 'N';
                            this.playlistFetcher.editPlaylist(prevDefault).subscribe(function (data) {
                                console.log(data);
                            });
                        }
                    }
                    ...
                    this.playlistFetcher.editPlaylist(this.playlists[input.index]).subscribe(function (data) {
                        if (input.isDefault) {
                            _this.defaultPlaylist = _this.playlists[input.index];
                        }
                    });
                };
                MusicPlayerComponent.prototype.onAddPlaylist = function (input) {
                    var _this = this;
                    var newPl = {
                        id: -2,
                    ...
                    this.playlistFetcher.addPlaylist(newPl).subscribe(function (data) {
                        newPl.id = data;
                        _this.playlists.push(newPl);
                        if (_this.playlists.length == 5) {
                            _this.addable = false;
                        }
                        if (input.isDefault) {
                            if (_this.defaultPlaylist.id != -1) {
                                _this.defaultPlaylist.isDefault = 'N';
                                _this.playlistFetcher.editPlaylist(_this.defaultPlaylist).subscribe(function (data) {
                                    console.log(data);
                                });
                            }
                            _this.defaultPlaylist = newPl;
                        }
                    });
                };
                MusicPlayerComponent.prototype.onExpCollapse = function (value) {
                    this.expanded = value;
                ...
                MusicPlayerComponent.prototype.onScreensizeChange = function (scrSz, expanded) {
                ...
                MusicPlayerComponent.prototype.addVideo = function (video) {
                    ...
                    if (localStorage.getItem('loggedIn') && localStorage.getItem('loggedIn') == 'true') {
                        var user = localStorage.getItem('username') ? localStorage.getItem('username') : 'Guest';
                        if (user != 'Guest') {
                            var index = this.playerQueue.length;
                            var id = video.id;
                            var prev = index == 0 ? 'first' : this.playerQueue[index - 1].lexoRank;
                            var next = 'last';
                            this.musicDataFetcher.setLexoRank(id, prev, next).subscribe(function (data) {
                                if (data == '-1') {
                                    return;
                                }
                                else {
                                    ...
                                    if (valArr.length > 1 && valArr[1] == 'rebalance') {
                                        _this.musicDataFetcher.rebalancePL(video.username, video.playlist).subscribe(function (data) {
                ...
                MusicPlayerComponent.prototype.onEditTitle = function (item) {
                    var _this = this;
                    console.log(item);
                    var index = item.index;
                    var title = item.title;
                    this.musicDataFetcher.editTitle(this.playerQueue[index].id, title).subscribe(function (data) {
                        if (data != -1) {
                            _this.playerQueue[index].title = title;
                        }
                    });
                };
                MusicPlayerComponent.prototype.playSong = function (index) {
                    this.playrComp.playIndexNumber(index);
                };
                MusicPlayerComponent.prototype.onChangePos = function (index) {
                    var _this = this;
                    if (localStorage.getItem('loggedIn') && localStorage.getItem('loggedIn') == 'true') {
                        var user = localStorage.getItem('username') ? localStorage.getItem('username') : 'Guest';
                        if (user != 'Guest') {
                            var id = this.playerQueue[index].id;
                            var prev = index == 0 ? 'first' : this.playerQueue[index - 1].lexoRank;
                            var next = index == this.playerQueue.length - 1 ? 'last' : this.playerQueue[index + 1].lexoRank;
                            this.musicDataFetcher.setLexoRank(id, prev, next).subscribe(function (data) {
                                if (data == '-1') {
                                    return;
                                }
                                    ...
                                    var valArr = data.split('@');
                                    _this.playerQueue[index].lexoRank = valArr[0];
                                    if (valArr.length > 1 && valArr[1] == 'rebalance') {
                                        _this.musicDataFetcher.rebalancePL(_this.playerQueue[index].username, _this.playerQueue[index].playlist).subscribe(function (data) {
                                            console.log("Rebalanced");
                                        });
                                    }
                                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var musicStyleService = /** @class */ (function () {
                ...
                musicStyleService.prototype.leftStyleSetter = function (scrSz, expanded) {
                    if (expanded) {
                        return {
                            'width': (scrSz.width - 3) + 'px',
                ...
                musicStyleService.prototype.rightStyleSetter = function (scrSz, expanded) {
                    if (expanded) {
                        return {
                            'width': (scrSz.width - 3) + 'px',
                ...
                musicStyleService.prototype.playerStyleSetter = function (scrSz, expanded) {
                    if (expanded) {
                        return {
                            'width': (scrSz.width - 3) + 'px',
                            'height': 6 * (scrSz.width - 3) / 16 + 'px',
                ...
                musicStyleService.prototype.largePlayerStyleSetter = function (scrSz, expanded) {
                    return {
                        'width': (scrSz.width - 3) + 'px',
                        'height': (0.97 * scrSz.height - 3) + 'px',
                        'background-color': 'rgba(0,0,0,0)',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".playr {\n  height: 100%;\n  width: 98%;\n  margin: auto;\n  position: relative;\n}\n.playr .screenSwap {\n  width: 100%;\n  height: 98%;\n  background-color: rgba(255, 255, 255, 0.5);\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  border-radius: 5px;\n}\n.playr .initText {\n  height: 100%;\n  position: relative;\n}\n.playr .initText .textIn {\n  font-size: 250%;\n  font-family: \"Cookie\", cursive;\n  width: 100%;\n  height: 38%;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  text-align: center;\n}\n.playr .repeatButton {\n  height: 70px;\n  left: 10%;\n  margin: -20px 0 0 -80px;\n  position: absolute;\n  top: 50%;\n  width: 160px;\n}\n.playr .repeatButton .icons {\n  height: 30%;\n  width: auto;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  flex-grow: 1;\n  margin: -10px 0 0 0;\n}\n.playr .expandCollPL {\n  transform: translateY(-50%);\n  z-index: 999;\n  font-size: 150%;\n  height: 29%;\n  left: 87%;\n  position: absolute;\n  top: 11%;\n  width: 60px;\n}\n.playr .expandCollPL .icons {\n  height: 35%;\n  width: auto;\n  position: absolute;\n  top: 40%;\n  transform: translateY(-50%);\n  flex-grow: 1;\n  margin: 0px 0 0 0;\n}\n.playr .expanded.expandCollPL {\n  height: 25%;\n  top: 17%;\n}\n.playr .shuffle {\n  height: 70px;\n  left: 90%;\n  margin: -20px 0 0 -80px;\n  position: absolute;\n  top: 50%;\n  width: 160px;\n}\n.playr .shuffle .icons {\n  height: 30%;\n  width: auto;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  flex-grow: 1;\n  margin: -10px 0 0 0;\n}\n.playr .repeatButton.up {\n  left: 50%;\n  top: 63%;\n  display: flex;\n  justify-content: center;\n  font-size: 150%;\n}\n.playr .repeatButton .icons.isNotMobile {\n  height: 60%;\n  left: 60%;\n}\n.playr .thumbnail {\n  width: 100%;\n  left: 0;\n  position: absolute;\n  top: 25%;\n}\n.playr .largeThumb {\n  display: flex;\n  justify-content: center;\n}\n.playr .bars {\n  height: 70px;\n  left: 50%;\n  margin: -40px 0 0 -80px;\n  position: absolute;\n  top: 45%;\n  width: 160px;\n}\n.playr .bars .icons {\n  height: 150%;\n  width: auto;\n  flex-grow: 1;\n  margin: -10px 0 0 0;\n}\n@media (max-width: 400px) {\n  .playr .bars {\n    top: 45%;\n  }\n}\n.playr .bar, .playr .staticbar {\n  background: #666;\n  bottom: 1px;\n  height: 30px;\n  position: absolute;\n  width: 12px;\n  -webkit-animation: sound 0ms -800ms linear infinite alternate;\n          animation: sound 0ms -800ms linear infinite alternate;\n}\n@-webkit-keyframes sound {\n  0% {\n    opacity: 0.35;\n    height: 15px;\n  }\n  100% {\n    opacity: 1;\n    height: 70px;\n  }\n}\n@keyframes sound {\n  0% {\n    opacity: 0.35;\n    height: 15px;\n  }\n  100% {\n    opacity: 1;\n    height: 70px;\n  }\n}\n.playr .bar:nth-child(1) {\n  left: 1px;\n  -webkit-animation-duration: 474ms;\n          animation-duration: 474ms;\n}\n.playr .bar:nth-child(2) {\n  left: 20px;\n  -webkit-animation-duration: 433ms;\n          animation-duration: 433ms;\n}\n.playr .bar:nth-child(3) {\n  left: 36px;\n  -webkit-animation-duration: 407ms;\n          animation-duration: 407ms;\n}\n.playr .bar:nth-child(4) {\n  left: 52px;\n  -webkit-animation-duration: 458ms;\n          animation-duration: 458ms;\n}\n.playr .bar:nth-child(5) {\n  left: 68px;\n  -webkit-animation-duration: 400ms;\n          animation-duration: 400ms;\n}\n.playr .bar:nth-child(6) {\n  left: 84px;\n  -webkit-animation-duration: 427ms;\n          animation-duration: 427ms;\n}\n.playr .bar:nth-child(7) {\n  left: 100px;\n  -webkit-animation-duration: 441ms;\n          animation-duration: 441ms;\n}\n.playr .bar:nth-child(8) {\n  left: 116px;\n  -webkit-animation-duration: 419ms;\n          animation-duration: 419ms;\n}\n.playr .bar:nth-child(9) {\n  left: 132px;\n  -webkit-animation-duration: 487ms;\n          animation-duration: 487ms;\n}\n.playr .bar:nth-child(10) {\n  left: 148px;\n  -webkit-animation-duration: 442ms;\n          animation-duration: 442ms;\n}\n.playr .staticbar:nth-child(1) {\n  left: 1px;\n  height: 30px;\n}\n.playr .staticbar:nth-child(2) {\n  left: 20px;\n  height: 70px;\n}\n.playr .staticbar:nth-child(3) {\n  left: 36px;\n  height: 50px;\n}\n.playr .staticbar:nth-child(4) {\n  left: 52px;\n  height: 30px;\n}\n.playr .staticbar:nth-child(5) {\n  left: 68px;\n  height: 70px;\n}\n.playr .staticbar:nth-child(6) {\n  left: 84px;\n  height: 50px;\n}\n.playr .staticbar:nth-child(7) {\n  left: 100px;\n  height: 30px;\n}\n.playr .staticbar:nth-child(8) {\n  left: 116px;\n  height: 70px;\n}\n.playr .staticbar:nth-child(9) {\n  left: 132px;\n  height: 50px;\n}\n.playr .staticbar:nth-child(10) {\n  left: 148px;\n  height: 30px;\n}\n.playr .utubeIcon {\n  width: 70%;\n  height: 16%;\n  position: absolute;\n  top: 88%;\n  left: 30%;\n  transform: translateY(-50%);\n  z-index: 999;\n  display: flex;\n  justify-content: space-around;\n  transition: display 3s;\n}\n.playr .utubeIcon.volClosed {\n  width: 70%;\n  left: 23%;\n}\n.playr .utubeIcon.left.volClosed {\n  width: 28%;\n  left: 0%;\n}\n.playr .utubeIcon.left {\n  width: 30%;\n  left: 0;\n  justify-content: center;\n}\n.playr .utubeIcon.left .icons {\n  width: 35%;\n}\n.playr .utubeIcon.left .volSlider {\n  width: 55%;\n  position: relative;\n}\n.playr .utubeIcon.left .slider {\n  -webkit-appearance: none;\n  position: absolute;\n  top: 45%;\n  left: 0%;\n  transform: translateY(-50%);\n  width: 100%;\n  height: 6px;\n  border-radius: 4px;\n  background: rgba(0, 0, 0, 0.8);\n  outline: none;\n  opacity: 0.7;\n  transition: opacity 0.2s;\n}\n.playr .utubeIcon.left .slider:hover {\n  opacity: 1;\n}\n.playr .utubeIcon.left .slider::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  appearance: none;\n  width: 12px;\n  height: 12px;\n  border-radius: 7px;\n  background: #4b90ff;\n  cursor: pointer;\n}\n.playr .utubeIcon.left .slider::-moz-range-thumb {\n  width: 25px;\n  height: 25px;\n  background: #4b90ff;\n  cursor: pointer;\n}\n.playr .expanded.utubeIcon {\n  height: 35%;\n  top: 82%;\n}\n.playr .utubeTitle {\n  width: 85%;\n  height: 12%;\n  position: absolute;\n  top: 10%;\n  transform: translateY(-50%);\n  z-index: 999;\n  display: flex;\n  justify-content: flex-start;\n  font-size: 150%;\n}\n.playr .utubeTitle .titleNm {\n  padding-left: 20px;\n  font-family: \"Ubuntu\", sans-serif;\n}\n.playr .ellFullTime {\n  width: 86%;\n  height: 12%;\n  position: absolute;\n  top: 75%;\n  left: 7%;\n  transform: translateY(-50%);\n  z-index: 999;\n  display: flex;\n  justify-content: space-between;\n  font-size: 80%;\n  padding-top: 2%;\n}\n.playr .expanded.ellFullTime {\n  top: 50%;\n}\n.playr .expanded.sliderPart {\n  height: 20%;\n  top: 45%;\n}\n.playr .sliderPart {\n  width: 90%;\n  height: 12%;\n  position: absolute;\n  top: 71%;\n  left: 5%;\n  transform: translateY(-50%);\n  z-index: 999;\n  display: flex;\n  justify-content: flex-start;\n  font-size: 150%;\n}\n.playr .sliderPart .slider {\n  -webkit-appearance: none;\n  width: 100%;\n  height: 0px;\n  margin-top: 4px;\n  border-radius: 4px;\n  background: #666;\n  outline: none;\n  opacity: 1;\n  transition: opacity 0.2s;\n}\n.playr .sliderPart .slider:hover {\n  opacity: 1;\n}\n.playr .sliderPart .slider::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  appearance: none;\n  width: 12px;\n  height: 12px;\n  border-radius: 7px;\n  background: linear-gradient(135deg, #003f41 0%, #00242b 35%);\n  cursor: pointer;\n}\n.playr .sliderPart .slider::-moz-range-thumb {\n  width: 12px;\n  height: 12px;\n  border-radius: 7px;\n  background: linear-gradient(135deg, #003f41 0%, #00242b 35%);\n  cursor: pointer;\n}\n.playr .expanded.utubeTitle {\n  height: 40%;\n  top: 27%;\n}\n@media (max-width: 400px) {\n  .playr .utubeTitle {\n    font-size: 100%;\n  }\n}\n@media (max-width: 400px) {\n  .playr .ellFullTime {\n    font-size: 60%;\n  }\n}\n.playr .icons {\n  height: 100%;\n  flex-grow: 1;\n}\n.playr .expanded .icons {\n  height: 80%;\n}\n.loader {\n  width: 30px;\n  height: 30px;\n  border: 8px solid rgba(0, 0, 0, 0.8);\n  border-radius: 50%;\n  border-top: 8px solid #00968775;\n  -webkit-animation: spin 2s linear infinite;\n  /* Safari */\n  animation: spin 2s linear infinite;\n}\n@-webkit-keyframes spin {\n  0% {\n    -webkit-transform: rotate(0deg);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n  }\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.slider1 {\n  -webkit-appearance: none;\n  width: 100%;\n  height: 4px;\n  border-radius: 4px;\n  background: #666;\n  outline: none;\n  opacity: 0.7;\n  transition: opacity 0.2s;\n  overflow: hidden;\n}\n.slider1::-webkit-slider-runnable-track {\n  background: #666;\n}\n/*\n * 1. Set to 0 width and remove border for a slider without a thumb\n */\n.slider1::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  width: 0px;\n  /* 1 */\n  height: 40px;\n  background: #fff;\n  box-shadow: -100vw 0 0 100vw rgba(1, 210, 189, 0.63);\n  border: 0px solid #999;\n  /* 1 */\n}\n.slider1::-moz-range-track {\n  height: 40px;\n  background: #ddd;\n}\n.slider1::-moz-range-thumb {\n  background: #fff;\n  height: 40px;\n  width: 20px;\n  border: 3px solid #999;\n  border-radius: 0 !important;\n  box-shadow: -100vw 0 0 100vw rgba(1, 210, 189, 0.63);\n  box-sizing: border-box;\n}\n.slider1::-ms-fill-lower {\n  background: rgba(1, 210, 189, 0.63);\n}\n.slider1::-ms-thumb {\n  background: #fff;\n  border: 2px solid #999;\n  height: 40px;\n  width: 20px;\n  box-sizing: border-box;\n}\n.slider1::-ms-ticks-after {\n  display: none;\n}\n.slider1::-ms-ticks-before {\n  display: none;\n}\n.slider1::-ms-track {\n  background: #ddd;\n  color: transparent;\n  height: 40px;\n  border: none;\n}\n.slider1::-ms-tooltip {\n  display: none;\n}\n.largePlayer .expanded.utubeIcon {\n  height: 30%;\n  top: 104%;\n}\n.largePlayer .utubeIcon.left.volClosed {\n  width: 21%;\n  left: 4%;\n}\n.largePlayer .utubeIcon.volClosed {\n  left: 27%;\n}\n.largePlayer .expanded.ellFullTime {\n  top: 90%;\n  font-size: 80%;\n}\n.largePlayer .expanded.sliderPart {\n  top: 91%;\n}\n.largePlayer .repeatButton {\n  top: 74%;\n}\n.largePlayer .shuffle {\n  top: 74%;\n}\n.largePlayer .bars {\n  top: 72%;\n}\n.largePlayer .utubeTitle {\n  font-size: 150%;\n  width: 70%;\n}\n.largePlayer .expanded.expandCollPL {\n  height: 25%;\n  left: 82%;\n  top: 12%;\n}\n@media (max-height: 1000px) and (min-width: 400px) {\n  .largePlayer .utubeTitle {\n    font-size: 180%;\n  }\n}\n@media (max-height: 1000px) {\n  .largePlayer .expanded .icons {\n    height: 20%;\n  }\n}\n@media (max-height: 1000px) {\n  .largePlayer .volSlider {\n    height: 20%;\n  }\n}\nbody {\n  overflow: hidden;\n}\n.container {\n  height: 25%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  overflow: hidden;\n  -webkit-animation-delay: 1s;\n          animation-delay: 1s;\n}\n.item-1 {\n  width: 20px;\n  height: 20px;\n  background: #f583a1;\n  border-radius: 50%;\n  border: 2px solid black;\n  background-color: #009687bd;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@-webkit-keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.item-1:before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: #009687bd;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 200ms;\n          animation-delay: 200ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.item-2 {\n  width: 20px;\n  height: 20px;\n  background: #f583a1;\n  border-radius: 50%;\n  border: 2px solid black;\n  background-color: #009688;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.item-2:before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: #009688;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 400ms;\n          animation-delay: 400ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.item-3 {\n  width: 20px;\n  height: 20px;\n  background: #f583a1;\n  border-radius: 50%;\n  border: 2px solid black;\n  background-color: #42b1a7;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.item-3:before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: #42b1a7;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 600ms;\n          animation-delay: 600ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.item-4 {\n  width: 20px;\n  height: 20px;\n  background: #f583a1;\n  border-radius: 50%;\n  border: 2px solid black;\n  background-color: #009688;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.item-4:before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: #009688;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 800ms;\n          animation-delay: 800ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.item-5 {\n  width: 20px;\n  height: 20px;\n  background: #f583a1;\n  border-radius: 50%;\n  border: 2px solid black;\n  background-color: #64ffdbea;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.item-5:before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: #64ffdbea;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 1000ms;\n          animation-delay: 1000ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.animation {\n  height: 15% !important;\n  background: #f583a1;\n  border: none;\n  background-color: transparent;\n  margin: 7px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@keyframes scale {\n  0% {\n    transform: scale(1);\n  }\n  50%, 75% {\n    transform: scale(2.5);\n  }\n  78%, 100% {\n    opacity: 0;\n  }\n}\n.animation:before {\n  content: \"\";\n  width: 35%;\n  height: 35%;\n  border-radius: 50%;\n  background-color: blue;\n  opacity: 0.7;\n  -webkit-animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n          animation: scale 2s infinite cubic-bezier(0, 0, 0.49, 1.02);\n  -webkit-animation-delay: 200ms;\n          animation-delay: 200ms;\n  transition: 0.5s all ease;\n  transform: scale(1);\n}\n.animation .icons {\n  height: 35% !important;\n}\n.icons.arrow {\n  top: 60% !important;\n  font-size: 1vh;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerComponent = /** @class */ (function () {
                function PlayerComponent(screenState, zone) {
                    var _this = this;
                    this.screenState = screenState;
                    this.zone = zone;
                    ...
                    window['angularComponentReference'] = {
                        zone: zone,
                        playFn: function () { return _this.play(); },
                        pauseFn: function () { return _this.pause(); },
                        nextFn: function () { return _this.next(); },
                        prevFn: function () { return _this.previous(); },
                        titleFn: function () { return _this.getTitle(); },
                        showPLFn: function () { return _this.showPL(); },
                        showLargePlayer: function () { return _this.largePlayerChange(); },
                        component: this,
                    };
                }
                PlayerComponent.prototype.logWhenPageHidden = function () {
                ...
                PlayerComponent.prototype.ngOnInit = function () {
                    ...
                    this.screenState.screenSize.subscribe(function (scrSz) {
                        _this.screenSt = scrSz;
                        var boxSize = Math.min(scrSz.width, scrSz.height / 1.5);
                        _this.imgStyle = {
                ...
                PlayerComponent.prototype.getTitle = function () {
                    return this.currentIndex >= 0 ? this.playerQueue[this.currentIndex].title : '';
                };
                PlayerComponent.prototype.onMinimize = function (event) {
                    console.log("blurred");
                    this.val = 1;
                };
                ...
                PlayerComponent.prototype.onSLiderChange = function () {
                    if (this.paused) {
                ...
                PlayerComponent.prototype.largePlayerChange = function () {
                    var largeState = this.largePlayer ? "small" : "large";
                    console.log("largePlayer|" + largeState);
                    this.largePlayer = !this.largePlayer;
                    this.onLargePlayerChange.emit(this.largePlayer);
                };
                PlayerComponent.prototype.onVolChange = function () {
                    this.player.setVolume(this.volume * 25);
                };
                PlayerComponent.prototype.showPL = function () {
                    if (this.largePlayer) {
                        this.largePlayerChange();
                    }
                };
                PlayerComponent.prototype.volToggle = function () {
                    var _this = this;
                    if (this.volTimeOut) {
                ...
                PlayerComponent.prototype.savePlayer = function (player) {
                    ...
                    this.sub = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(1000)
                        ...
                        _this.songTime = _this.player.getDuration();
                        _this.loadedTime = _this.player.getVideoLoadedFraction() * _this.songTime;
                        if (_this.playerState == 2 && _this.loadedTime <= _this.elapsedTime) {
                            _this.loading = true;
                        }
                    });
                    this.initializing = true;
                    setTimeout(function () {
                        if (_this.playerQueue.length == 0) {
                            ...
                            _this.OnIndChanges();
                            _this.player.loadVideoById(_this.playerQueue[_this.currentIndex].videoId);
                            _this.pause();
                ...
                PlayerComponent.prototype.queueInitializer = function () {
                    this.queInitilized = true;
                };
                PlayerComponent.prototype.playIndexNumber = function (index) {
                    var _this = this;
                ...
                PlayerComponent.prototype.next = function () {
                    ...
                    if (this.shuffleOn) {
                        var index = Math.floor(Math.random() * (this.playerQueue.length));
                        var index2 = Math.floor(Math.random() * (this.playerQueue.length - 1));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QueueComponent = /** @class */ (function () {
                function QueueComponent(musicDataFetcher, dialog, screenState) {
                    this.musicDataFetcher = musicDataFetcher;
                    this.dialog = dialog;
                    this.screenState = screenState;
                    this.expanded = false;
                ...
                QueueComponent.prototype.OnIndChanges = function () {
                    //console.log(this.currentIndex);
                    this.onIndexChange.emit(this.currentIndex);
                };
                QueueComponent.prototype.addVideo = function (event) {
                    this.onAdd.emit(event);
                };
                QueueComponent.prototype.hideSear = function (event) {
                ...
                QueueComponent.prototype.ngOnInit = function () {
                    ...
                    this.screenState.screenSize.subscribe(function (screen) {
                        if (!screen.isMobile) {
                            _this.expanded = true;
                            _this.showExpand = false;
                            _this.onExpandCollapse();
                        }
                        else {
                ...
                QueueComponent.prototype.scrollPlacement = function () {
                    var _this = this;
                    setTimeout(function () {
                        _this.divToScroll.nativeElement.scrollTop = (_this.currentIndex) * 60;
                    }, 200);
                };
                QueueComponent.prototype.selectPL = function (index) {
                    console.log(index, "selected");
                    this.onChangePlaylist.emit(index);
                    this.isClosed = true;
                };
                QueueComponent.prototype.addPL = function () {
                    var _this = this;
                    var names = [];
                    this.playlists.forEach(function (element) {
                        names.push(element.playlist);
                    });
                    var dialogRef = this.dialog.open(ModifyAddDialog, {
                        width: '250px',
                ...
                QueueComponent.prototype.editPL = function (index) {
                    var _this = this;
                    var names = [];
                    this.playlists.forEach(function (element) {
                        names.push(element.playlist);
                ...
                QueueComponent.prototype.deletePL = function (index) {
                    var _this = this;
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        ...
                        if (result && result.returnVal) {
                            _this.onDeletePlaylist.emit(index);
                        }
                    });
                    this.isClosed = true;
                };
                QueueComponent.prototype.onExpandCollapse = function () {
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        ...
                        if (result && result.returnVal) {
                            if (localStorage.getItem('loggedIn') && localStorage.getItem('loggedIn') == 'true') {
                                var user = localStorage.getItem('username') ? localStorage.getItem('username') : 'Guest';
                                if (user != 'Guest') {
                                    var videoElem = _this.playerQueue[index];
                                    _this.musicDataFetcher.deleteSong(videoElem).subscribe(function (data) {
                                        console.log(data);
                                    });
                                }
                            }
                            ...
                            _this.playerQueue.splice(index, 1);
                        }
                    });
                };
                QueueComponent.prototype.editTitle = function (index) {
                    var _this = this;
                ...
                QueueComponent.prototype.playSong = function (index) {
                    var _this = this;
                    setTimeout(function () {
                        if (_this.isRemSong || _this.isEditSong) {
                            _this.isRemSong = false;
                            _this.isEditSong = false;
                            return;
                        }
                        _this.onDoubleClic.emit(index);
                    }, 100);
                };
            ...
            var ModifyAddDialog = /** @class */ (function () {
                function ModifyAddDialog(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                ...
                ModifyAddDialog.prototype.ngOnInit = function () {
                ...
                ModifyAddDialog.prototype.onNameChange = function () {
                ...
                ModifyAddDialog.prototype.onBoolChange = function () {
                    this.origBool = !this.origBool;
                };
                ModifyAddDialog.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                return ModifyAddDialog;
            }());
            ModifyAddDialog.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlaylistDataFetcher = /** @class */ (function () {
                function PlaylistDataFetcher(dataFetcher) {
                    this.dataFetcher = dataFetcher;
                }
                PlaylistDataFetcher.prototype.getAllPlaylists = function (user) {
                    var uri = "playlist/getAll/" + user;
                    return this.dataFetcher.get(uri);
                };
                PlaylistDataFetcher.prototype.addPlaylist = function (playlist) {
                    var uri = "playlist/saveItem";
                    return this.dataFetcher.post(uri, playlist);
                };
                PlaylistDataFetcher.prototype.deletePlaylist = function (playlist) {
                    var uri = "playlist/deleteItem";
                    return this.dataFetcher.post(uri, playlist);
                };
                PlaylistDataFetcher.prototype.editPlaylist = function (playlist) {
                    var uri = "playlist/editItem";
                    return this.dataFetcher.post(uri, playlist);
                };
                return PlaylistDataFetcher;
            }());
            PlaylistDataFetcher.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicDataFetcher = /** @class */ (function () {
                ...
                MusicDataFetcher.prototype.editTitle = function (id, title) {
                    var uri = "music/update/" + id + "/" + title;
                    return this.dataFetcher.get(uri);
                };
                ...
                MusicDataFetcher.prototype.setLexoRank = function (id, prev, next) {
                    var uri = "lexo/setLexorank";
                    return this.dataFetcher.post(uri, { id: id, prev: prev, next: next });
                };
                MusicDataFetcher.prototype.rebalancePL = function (usernm, playlist) {
                    var uri = "lexo/rebalance/" + usernm + "/" + playlist;
                    return this.dataFetcher.get(uri);
                };
                MusicDataFetcher.prototype.getYoutubeAutocomplete = function (query) {
                    var uri = "music/getSuggestions/" + query;
                    return this.dataFetcher.get(uri);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var screenSizeState = /** @class */ (function () {
                ...
                screenSizeState.prototype.getCurrentScreen = function () {
            ...
            var SignUpComponent = /** @class */ (function () {
                ...
                SignUpComponent.prototype.registerUser = function () {
                    ...
                    this.dataFetcher.addUser(user).subscribe(function (data) {
                        ...
                        _this.allUsername.push(_this.username);
                        _this.allEmail.push(_this.eml);
                    });
                };
