(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicAddComponent = /** @class */ (function () {
                function MusicAddComponent(dialog, screenState, musicDataFetcher) {
                    this.dialog = dialog;
                    this.screenState = screenState;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicPlayerComponent = /** @class */ (function () {
                function MusicPlayerComponent(screenState, styleSetter, musicDataFetcher, playlistFetcher) {
                    this.screenState = screenState;
                    this.styleSetter = styleSetter;
                    this.musicDataFetcher = musicDataFetcher;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerComponent = /** @class */ (function () {
                ...
                PlayerComponent.prototype.left = function () {
                    console.log("swipe left");
                    this.previous();
                };
                PlayerComponent.prototype.right = function () {
                    console.log("swipe right");
                    this.next();
                };
                PlayerComponent.prototype.panstart = function (event) {
                    console.log(event, event.x, event.y);
                };
                PlayerComponent.prototype.panmove = function (event) {
                    console.log(event, event.x, event.y);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".queue {\n  height: 100%;\n  width: 98%;\n  margin: auto;\n  position: relative;\n}\n.queue .box {\n  width: 100%;\n  height: 98%;\n  background-color: rgba(255, 255, 255, 0.3);\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  border-radius: 5px;\n}\n.queue .queueHeader {\n  height: 8%;\n  max-height: 40px;\n  display: flex;\n  justify-content: space-between;\n  padding: 0px 20px;\n}\n.queue .queueHeader .expand {\n  font-size: 90%;\n  padding-top: 3px;\n  font-weight: bold;\n  color: #1e3d26;\n}\n.queue .queueHeader .dropbox {\n  width: 70%;\n  height: 95%;\n  color: white;\n  font-family: \"Ubuntu\", sans-serif;\n  display: flex;\n  justify-content: space-between;\n  position: relative;\n}\n.queue .queueHeader .dropbox .addPL {\n  width: 20%;\n  color: rgba(0, 0, 0, 0.8);\n}\n.queue .queueHeader .dropbox .addPL .icons {\n  width: 15%;\n  height: 60%;\n  top: 20%;\n  position: absolute;\n  left: 75%;\n}\n.queue .queueHeader .dropbox .addPL .expand.icons {\n  left: 80%;\n}\n.queue .queueHeader .dropbox .content {\n  width: 75%;\n  background-color: rgba(0, 0, 0, 0.5);\n  border-radius: 50px;\n  position: relative;\n}\n.queue .queueHeader .dropbox .content .iconn {\n  color: white;\n  width: 10%;\n  padding-top: 5%;\n  padding-left: 6%;\n}\n.queue .queueHeader .dropbox .content .playlistName {\n  width: 70%;\n  position: absolute;\n  transform: translateY(-50%);\n  top: 50%;\n  left: 20%;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n.queue .queueHeader .dropbox .content .arrow {\n  width: 5%;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  right: 5%;\n}\n.queue .queueHeader .dropbox .content .arrow .icons {\n  height: 100%;\n  width: 100%;\n  rotate: 90;\n}\n.queue .queueHeader .dropbox .optionList {\n  width: 120%;\n  min-width: 230px;\n  position: absolute;\n  top: 100%;\n  left: 5px;\n  z-index: 9999;\n  background-color: #f0f0f0;\n  color: #272727;\n  border-radius: 5px;\n}\n.queue .queueHeader .dropbox .optionList .selected {\n  color: #2D5036;\n  font-size: 85%;\n  font-weight: bold;\n}\n.queue .queueHeader .dropbox .optionList .listItems {\n  width: 100%;\n  height: 40px;\n  display: flex;\n  justify-content: space-between;\n  position: relative;\n  font-size: 80%;\n}\n.queue .queueHeader .dropbox .optionList .listItems .listItem {\n  width: 70%;\n  position: absolute;\n  top: 50%;\n  left: 5%;\n  transform: translateY(-50%);\n}\n.queue .queueHeader .dropbox .optionList .listItems .border {\n  width: 90%;\n  position: absolute;\n  top: 2.5%;\n  left: 5%;\n  transform: translateY(-50%);\n  border-top: 1px solid rgba(0, 0, 0, 0.1);\n}\n.queue .queueHeader .dropbox .optionList .listItems .listItems:nth-child(1) .border {\n  border-top: 0px solid black;\n}\n.queue .queueHeader .dropbox .optionList .listItems .optionIcon {\n  width: 30%;\n  height: 100%;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  right: 0;\n}\n.queue .queueHeader .dropbox .optionList .listItems .optionIcon .icons {\n  height: 100%;\n  width: 30%;\n  padding-left: 10%;\n}\n.queue .queueHeader .select-items {\n  border-radius: 10px;\n}\n.queue .example-box.loginDisclaimer {\n  margin-top: 5px;\n  height: 30px;\n  background: rgba(220, 20, 60, 0.356);\n}\n.queue .example-box.loginDisclaimer .songTitle {\n  width: 100%;\n  color: #5c0101;\n  text-align: center;\n}\n.queue .songList.smaller {\n  height: 84%;\n}\n.queue .queElements {\n  width: 95%;\n  height: 10%;\n  margin: auto;\n  position: relative;\n}\n.queue .queueElem {\n  width: 100%;\n  height: 90%;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  background: rgba(165, 42, 42, 0.5);\n  display: flex;\n  justify-content: flex-start;\n}\n.queue .queueElem.current {\n  background: brown;\n}\n.queue .thumbNail {\n  height: 100%;\n  width: 30%;\n  margin: auto;\n  position: relative;\n}\n.queue .thumbNail > img {\n  height: 90%;\n  width: 100%;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  border-radius: 50%;\n}\n.queue .songTitle {\n  height: 100%;\n  width: 65%;\n}\n.example-list {\n  width: 500px;\n  max-width: 100%;\n  min-height: 60px;\n  padding-top: 5px;\n  display: block;\n  background: white;\n  border-radius: 4px;\n}\n.songList {\n  height: 89%;\n  overflow: auto;\n  margin-top: 5px;\n}\n.songList::-webkit-scrollbar {\n  width: 4px;\n}\n.example-box {\n  width: 95%;\n  margin: auto;\n  margin-bottom: 5px;\n  height: 60px;\n  padding: 1%;\n  color: white;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: flex-start;\n  box-sizing: border-box;\n  cursor: pointer;\n  background: rgba(0, 0, 0, 0.6);\n  border-radius: 5px;\n  font-size: 100%;\n  position: relative;\n}\n.example-box .thumbNail {\n  width: 60px;\n  margin-left: 5px;\n  margin-right: 5px;\n  position: relative;\n}\n.example-box .thumbNail > img {\n  height: 90%;\n  width: auto;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  border-radius: 50%;\n}\n.example-box .handler {\n  cursor: move;\n}\n.example-box .songTitle {\n  height: auto;\n  width: 55%;\n  padding-left: 5%;\n  padding-right: 5%;\n  padding-top: 2%;\n  padding-bottom: 2%;\n  font-family: \"Ubuntu\", sans-serif;\n  font-weight: 300;\n  line-height: 25px;\n  word-break: break-word;\n}\n.example-box .closer {\n  position: absolute;\n  top: 8px;\n  right: 8px;\n}\n.example-box .closer .icons {\n  height: 15px;\n  width: 15px;\n  rotate: 90;\n}\n.example-box .player {\n  position: absolute;\n  bottom: 0px;\n  right: 8px;\n  z-index: 999;\n}\n.example-box .player .icons {\n  height: 25px;\n  width: 25px;\n  rotate: 90;\n}\n.cdk-drag-preview {\n  box-sizing: border-box;\n  border-radius: 4px;\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n.cdk-drag-placeholder {\n  opacity: 0;\n}\n.cdk-drag-animating {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n.example-box:last-child {\n  border: none;\n}\n.example-list.cdk-drop-list-dragging .example-box:not(.cdk-drag-placeholder) {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n.current {\n  background: rgba(0, 0, 0, 0.9);\n  color: #01D2BE;\n}\n.current .thumbNail {\n  padding-left: 26px;\n}\n.adderPart {\n  position: absolute;\n  top: 0;\n  left: 0;\n  height: 8%;\n  max-height: 40px;\n  width: 100%;\n  z-index: 9999;\n}\n.sendBack.adderPart {\n  width: 30%;\n  left: 84%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
