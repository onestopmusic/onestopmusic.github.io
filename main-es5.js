(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DemoComponent = /** @class */ (function () {
                function DemoComponent(screenState, styleSetter, router, loginDtaFetcher) {
                ...
                DemoComponent.prototype.onScreensizeChange = function (scrSz) {
                ...
                DemoComponent.prototype.goToMusic = function () {
                    this.router.navigateByUrl("/music");
                };
                DemoComponent.prototype.buttonClicked = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var demoStyleService = /** @class */ (function () {
                function demoStyleService() {
                }
                demoStyleService.prototype.loginStyleSetter = function (scrSz) {
                ...
                demoStyleService.prototype.errorStyleSetter = function (scrSz) {
                ...
                demoStyleService.prototype.loaderStyleSetter = function (scrSz) {
                    var boxSize = 0.4 * Math.min(scrSz.width, scrSz.height);
                    return {
                ...
                demoStyleService.prototype.picStyleSetter = function (scrSz) {
                    return {
                ...
                demoStyleService.prototype.bottomStyler = function (scrSz) {
                ...
                demoStyleService.prototype.fullLogoStyler = function (scrSz) {
                    var boxSize = 0.6 * Math.min(scrSz.width, scrSz.height);
                    return {
                        'line-height': '1px',
                    };
                };
                return demoStyleService;
            }());
                ...
                PlayerComponent.prototype.initialize = function () {
                    ...
                    setTimeout(function () {
                        ...
                        if (_this.playerQueue.length == 0) {
                            if (_this.screenSt.isMobile) {
                                _this.largePlayerChange();
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignUpComponent = /** @class */ (function () {
                function SignUpComponent(_autofill, dialog, dataFetcher, router, screenState, styleSetter) {
                ...
                SignUpComponent.prototype.navigateToDemoOrPlayer = function () {
                    var _this = this;
                    if (!this.scrSz.isMobile) {
                        this.router.navigateByUrl("/music");
                        return;
                    }
                    var dialogRef = this.dialog.open(DemoConfirmDialog, {
                        width: '300px',
                        data: "Demo"
                    });
                    dialogRef.afterClosed().subscribe(function (result) {
                        ...
                        if (result && result == 'demo') {
                            _this.router.navigateByUrl("/demo");
                        }
            ...
            var DemoConfirmDialog = /** @class */ (function () {
                function DemoConfirmDialog(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                }
                DemoConfirmDialog.prototype.ngOnInit = function () {
                };
                DemoConfirmDialog.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                return DemoConfirmDialog;
            }());
            DemoConfirmDialog.ctorParameters = function () { return [
