                ...
                MusicPlayerComponent.prototype.ngAfterViewInit = function () {
                    ...
                    if (localStorage.getItem('loggedIn') !== null) {
                        ...
                        if (this.loggedInUser != 'Guest') {
                            ...
                            var lastPlaylist_1 = localStorage.getItem('playlist') != null ? JSON.parse(localStorage.getItem('playlist')) : null;
                            var lastIndexId_1 = localStorage.getItem('lastIndex') != null ? JSON.parse(localStorage.getItem('lastIndex')) : null;
