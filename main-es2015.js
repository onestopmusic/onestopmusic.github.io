    ...
    ngAfterViewInit() {
        ...
        if (localStorage.getItem('loggedIn') !== null) {
            ...
            if (this.loggedInUser != 'Guest') {
                ...
                let lastPlaylist = localStorage.getItem('playlist') != null ? JSON.parse(localStorage.getItem('playlist')) : null;
                let lastIndexId = localStorage.getItem('lastIndex') != null ? JSON.parse(localStorage.getItem('lastIndex')) : null;
